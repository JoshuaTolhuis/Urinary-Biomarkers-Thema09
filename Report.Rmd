...
The Rstudio was used to create a research paper and make an Explorotory Data Analysis (EDA).   
## Results  
The result of this study were that it is possible to leave out the factors, age and the sex. The most important variables were the biomarkes used, the creatinine and the bloodplasma. 

## Conclusion
The conclusion gotten is that creatinine, bloodplasma and the biomarkers are very usefull for prediction for prediction of cancer stages.
...
## Materials
The data obtained was gainend from [kaggle](https://www.kaggle.com/johnjdavisiv/urinary-biomarkers-for-pancreatic-cancer)[1]

For this project mainly programming software and libraries were used.  
Also Weka was used in order to optain an ROC curve.  
...
Java, Gradle and Java's SDK and JDK were used to create an tool which uses a Weka algorithm to predict cancer stages from a specifiek file. Java also used R to correct the file inserted into via the commandline.
